...
<Callout type="info">
**Signed in:** Copilot uses `POST /api/ai/chat` and requires signing in plus server configuration (`ANTHROPIC_API_KEY`). Content is processed by **Anthropic**—do not send secrets or regulated data.
</Callout>
