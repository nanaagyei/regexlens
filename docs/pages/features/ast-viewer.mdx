...
The Structure tab shows the internal Abstract Syntax Tree (AST) of your regex.

See also the **Railroad** tab for a complementary diagram view—[Railroad diagram](/features/railroad-diagram).
