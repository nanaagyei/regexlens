...
For the in-app **Safety** tab behavior, read [Safety (advanced analysis)](/features/analysis). This page expands on workflows and mirrors the `POST /api/analyze` contract.
</Callout>
